...
const HomePage = () => {
    ...
    <div className="row align-items-center"/>
      <div className="btn toolbar pull-right fs-5 pb-0 align-items-center"></div>
      </nav>
    ...
    <div className="container p-3 fw-bold border border-white text-center">
  ...
  <div className="container align-items-lg-stretch">
    <div className="container row bg-white p-4 justify-content-around">
      ...
      <div className="col-sm col mb-4">
        <div className="card  h-100" style={{width: 250}}>
          ...
          <div className="card-body border primary">
            ...
            <a href="LinksToAllJobs/InteriorDesign.html" className="btn btn-primary">Learn More</a>
          </div>
        </div>
      </div>
      ...
      <div className="col-sm col mb-4">
        <div className="card h-100" style={{width: 250}}>
          ...
          <div className="card-body border primary">
            ...
            <p className="card-text">Offering fast and accurate mounting services. We can handle basic and custom mounting to beautify and declutter your space.</p>
            <a href="LinksToAllJobs/Mounting.html" className="btn btn-primary">Learn More</a>
          </div>
        </div>
      </div>
      ...
      <div className="col-sm col mb-4">
        <div className="card h-100" style={{width: 250}}>
          ...
          <div className="card-body border primary">
            ...
            <p className="card-text">Offering full service repair and maintenance services. We help you develop the best plan for your plumbing or drainage needs.</p>
            <a href="LinksToAllJobs/Plumbering.html" className="btn btn-primary">Learn More</a>
          </div>
        </div>
      </div>
      ...
      <div className="col-sm col mb-4">
        <div className="card h-100" style={{width: 250}}>
          ...
          <div className="card-body border primary">
            ...
            <p className="card-text">From weekly mowing to custom landscapes we are ready to get your project off the ground. Let us enhance your curb appeal.</p>
            <a href="LinksToAllJobs/Landscaping.html" className="btn btn-primary">Learn More</a>
          </div>
        </div>
      </div>
      ...
      <div className="col-sm col mb-4">
        <div className="card h-100" style={{width: 250}}>
          ...
          <div className="card-body border primary">
            ...
            <p className="card-text">Providing solutions for residential and commercial cleaning needs. Give us a try and we'll get the job done right the first time.</p>
            <a href="LinksToAllJobs/HouseKeeping.html" className="btn btn-primary">Learn More</a>
          </div>
        </div>
      </div>
      ...
      <div className="col-sm col mb-4">
        <div className="card h-100" style={{width: 250}}>
          ...
          <div className="card-body border primary">
            ...
            <p className="card-text">Providing solutions for residential and commercial flooring needs. We've got you covered for complete repairs and installs.</p>
            <a href="LinksToAllJobs/Flooring.html" className="btn btn-primary">Learn More</a>
          </div>
        </div>
      </div>
      ...
      <div className="col-sm col mb-4">
        <div className="card h-100" style={{width: 250}}>
          ...
          <div className="card-body border primary">
            ...
            <p className="card-text">We provide testing and maintenance services to maintain your private spa and keep you swimming as long as the weather allows.  </p>
            <a href="LinksToAllJobs/PoolMaint.html" className="btn btn-primary">Learn More</a>
          </div>
        </div>
      </div>
      ...
      <div className="col-sm col mb-4">
        <div className="card h-100" style={{width: 250}}>
          ...
          <div className="card-body border primary">
            ...
            <p className="card-text">We provide initial consulting services to get you the right protection for your home when you need it; then we install it for you.</p>
            <a href="LinksToAllJobs/HomeSecurity.html" className="btn btn-primary">Learn More</a>
          </div>
        </div>
      </div>
    </div>
